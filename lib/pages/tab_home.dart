...
List<Page> _allPages = <Page>[
  Page( text: 'Jhumkis', category: 'category-name'),
  Page( text: 'Chandelier', category: 'category-name'),
  Page( text: 'Chand Balis', category: 'category-name'),
  Page( text: 'Kashmiri Dejhoor', category: 'category-name'),
  Page( text: 'Danglers To Dazzle', category: 'category-name'),
  Page(
      text: 'Early Access',
 ...
 /* _buildFilterWidgets(Size screenSize) {
  ...
  Widget build(BuildContext context) {
    final List<Widget> tabChildernPages = <Widget>[];
     _allPages.forEach(
       (Page page) => tabChildernPages.add(buildProductsListPage()));
